...
ALTER TABLE "public"."FriendshipRequest" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "public"."FriendshipRequest" ALTER COLUMN "status" TYPE "public"."FriendshipStatus_new" USING ("status"::text::"public"."FriendshipStatus_new");
...
ALTER TABLE "public"."FriendshipRequest" ALTER COLUMN "status" SET DEFAULT 'PENDING';
COMMIT;
